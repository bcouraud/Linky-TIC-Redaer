...
#define STASSID "Internetbox-SSID"
#define STAPSK "InternetBoxPWD"
...
String httpRequestData = "linkySensor,sensor_id=LinkyAppartment_github power="+String(puissanceCommuniquee)+",danger="+String(Danger)+",voltage=234.231,frequency=50.2,pf=0.9 "+String(epoch_time)+"000000000";
