...
\begin{document}
	...
	%\author{\IEEEauthorblockN{1\textsuperscript{st} Benoit Couraud}
		...
		\author{\IEEEauthorblockN{Benoit Couraud$^{1,2}$, Pierre-Jean Barre$^{2}$, Roberta Pennucci$^{2}$, Yann Rozier$^{2}$, Merlinda Andoni$^{1}$, Sonam Norbu$^{1}$,\\  David Flynn$^{1}$}
			...
			\IEEEauthorblockA{$^1$ James Watt School of Engineering, University of Glasgow, Glasgow (UK)\\
				...
				Email: $\{$benoit.couraud, pierre-jean.barre, roberta.pennucci, yann.rozier$\}$@univ-cotedazur.fr}
	...
	\begin{abstract}
		...
		Furthermore, this article describes several potential applications of the data collected by the LTR, such as load management, non-intrusive load monitoring and load forecasting. 
	\end{abstract}
